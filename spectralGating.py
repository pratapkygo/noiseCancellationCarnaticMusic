...
#LOADdata
wav_loc = 'C:/Users/Admin/Downloads/carnaticclean.wav'
...
#ADD NOISE
noise_len = 11 # seconds
noise = band_limited_noise(min_freq=4000, max_freq = 12000, samples=len(data), samplerate=rate)*10000
